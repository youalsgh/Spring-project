			...
			<div class="row h-100 justify-content-center"
				...
				<div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
					<div class="bg-white rounded p-4 p-sm-5 my-4 mx-3">
						...
						<span class="id_check_success">사용가능한 아이디입니다.</span>
						<span class="id_check_fail">아이디가 이미 존재합니다.</span>
						<span class="final_id_ck">아이디를 입력해주세요.</span>
						
						<div class="form-floating mb-4">
							<input type="password" class="form-control pw_check" id="floatingPassword"
						...
						<div class="form-floating mb-4">
							<input type="password" class="form-control pw_checkCheck" id="floatingPasswordCheck"
								name="passwordCheck" placeholder="Password"> <label
						...
						<div class="form-floating mb-3">
							<input type="text" class="form-control name_check" id="floatingName"
								name="name" placeholder="User name"> <label
								for="floatingName">User name</label>
						</div>
						<span class="final_name_ck">이름을 입력해주세요.</span>
						
						<div class="form-floating mb-3">
							<input type="email" class="form-control email_check" id="floatingEmail"
								name="email" placeholder="Email"> <label
								for="floatingEmail">Email</label>
						</div>
						<span class="final_mail_ck">이메일을 입력해주세요.</span>
						
						<button class="btn btn-success py-3 w-100 mb-4 signup_button">Sign
							Up</button>
					</div>
				</div>
			</div>
	...
	<script>
		...
		$(document).ready(function(){
			$(".signup_button").click(function(){
				...
				/* 최종 유효성 검사 */
				if(idCheck&&idckCheck&&pwCheck&&pwckcorCheck&&nameCheck&&mailCheck){
		...
		/* 비밀번호 확인 일치 유효성 검사 */
		$('.pw_checkCheck').on("propertychange change keyup paste input", function(){
		...
		$('.id_check').on("propertychange change keyup paste input", function() {
			...
			var data = {memberId : memberId} // 컨트롤에 넘길 데이터 이름 : 데이터(.id_check에 입력되는 값)
